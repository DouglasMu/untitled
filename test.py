...
for page in range(pages):  # 12.13 edit
    print "Page %i ..." % (page + 1)
    url = "https://sclub.jd.com/comment/productPageComments.action?productId=" + pid + "&score=0&sortType=3&page=" + str(
        page) + "&pageSize=10&callback=fetchJSON_comment98vv37464"
...
df = pd.DataFrame({"cmt": l_cmt,
                   ...
                   "nn": l_nn,
                   "client": l_client})
df.to_csv('E:/file.csv', index=False)
print "done.."
import winsound
